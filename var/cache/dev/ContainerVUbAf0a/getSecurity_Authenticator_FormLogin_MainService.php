...
class getSecurity_Authenticator_FormLogin_MainService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.authenticator.form_login.main'] = new \Symfony\Component\Security\Http\Authenticator\FormLoginAuthenticator($b, ($container->privates['security.user.provider.concrete.user_provider'] ?? $container->load('getSecurity_User_Provider_Concrete_UserProviderService')), $d, $e, ['login_path' => 'login', 'check_path' => 'login', 'username_parameter' => '_username', 'password_parameter' => '_password', 'enable_csrf' => true, 'use_forward' => false, 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true, 'form_only' => false]);
    }
}
