...
class __TwigTemplate_3586ef313ec2a64058aa777b61b11677 extends Template
{
...
";
    ...
    public function block_main(array $context, array $blocks = []): iterable
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["cardDeck"]) {
            ...
            // line 43
            $context['_parent'] = $context;
            $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, $context["cardDeck"], "cards", [], "any", false, false, false, 43));
            foreach ($context['_seq'] as $context["_key"] => $context["card"]) {
                // line 44
                yield "                        <a href=\"";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("card", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["card"], "id", [], "any", false, false, false, 44)]), "html", null, true);
                yield "\">
                ...
                // line 47
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("/assets/images/content/card/" . CoreExtension::getAttribute($this->env, $this->source, $context["card"], "image", [], "any", false, false, false, 47))), "html", null, true);
                yield "');\">
                                    <data class=\"flex flex-row gap-2 text-xl font-semibold text-black-600 dark:white\">
                                        <span>";
                // line 49
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["card"], "health", [], "any", false, false, false, 49), "html", null, true);
                yield "</span>
                                        <!-- Icono de vida -->
                ...
                // line 58
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["card"], "name", [], "any", false, false, false, 58), "html", null, true);
                yield "</h4>
                ...
                // line 61
                $context['_parent'] = $context;
                $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, $context["card"], "abilities", [], "any", false, false, false, 61));
                foreach ($context['_seq'] as $context["_key"] => $context["ability"]) {
                    // line 62
                    yield "                                            <li class=\"flex-1 grid grid-cols-2 items-center\">
                                                <span>";
                    // line 63
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["ability"], "name", [], "any", false, false, false, 63), "html", null, true);
                    yield "</span>
                                                ...
                                                <div class=\"grid grid-cols-2 gap-8 justify-self-end text-xs\">
                                                    <data class=\"flex flex-row gap-2 items-center font-semibold text-black-600 dark:text-white-400\">
                                                        <span>";
                    // line 67
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["ability"], "cost", [], "any", false, false, false, 67), "html", null, true);
                    yield "</span>
                                                        <!-- Icono de coste -->
                                                        <svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\" fill=\"currentColor\" class=\"size-6\">
                                                    ...
                                                    <data class=\"flex flex-row gap-2 items-center font-semibold text-black-600 dark:text-white-400\">
                                                        <span>";
                    // line 75
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["ability"], "value", [], "any", false, false, false, 75), "html", null, true);
                    yield "</span>
                                                        <!-- Icono de poder -->
                                                        <svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\" fill=\"currentColor\" class=\"size-6\">
...
";
    ...
    {
        return array (  299 => 92,  291 => 89,  281 => 84,  266 => 75,  255 => 67,  248 => 63,  245 => 62,  241 => 61,  235 => 58,  223 => 49,  218 => 47,  211 => 44,  207 => 43,  201 => 39,  196 => 37,  192 => 36,  188 => 35,  183 => 34,  179 => 32,  177 => 31,  169 => 26,  164 => 24,  156 => 19,  152 => 18,  148 => 17,  143 => 14,  139 => 13,  136 => 12,  123 => 11,  110 => 8,  106 => 7,  101 => 6,  88 => 5,  65 => 3,  42 => 1,);
    }
...
{% endblock %}
", "card-deck/list.html.twig", "/Users/ulises/PhpstormProjects/proyecto-integrado/templates/card-deck/list.html.twig");
    }
}
