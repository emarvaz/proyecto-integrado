...
class __TwigTemplate_dd42713561e7b7ae5d3a92bdc2999455 extends Template
{
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
            ...
            yield "                </td>
                <td>
                    <a href=\"";
            // line 32
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("administration_user_edit", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["user"], "id", [], "any", false, false, false, 32)]), "html", null, true);
            yield "\">Editar</a>
                    <a href=\"";
            // line 33
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("administration_user_delete", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["user"], "id", [], "any", false, false, false, 33)]), "html", null, true);
            yield "\">Eliminar</a>
                </td>
            </tr>
        ";
...
";
    ...
    {
        return array (  200 => 37,  190 => 33,  186 => 32,  182 => 30,  168 => 29,  162 => 28,  145 => 27,  140 => 25,  136 => 24,  132 => 23,  128 => 22,  124 => 21,  121 => 20,  117 => 19,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
