...
class __TwigTemplate_8525e287e19a30ae50a4f89fb76ce539 extends Template
{
    ...
    public function block_main(array $context, array $blocks = []): iterable
    {
        ...
        yield "</h1>
                ...
                <ul class=\"space-y-3 text-lg text-gray-700 dark:text-gray-300\">
                    <li><span class=\"font-semibold text-gray-900 dark:text-white\">Nombre de usuario:</span> ";
        // line 20
        ...
        yield "</li>
                    <li><span class=\"font-semibold text-gray-900 dark:text-white\">Nombre:</span> ";
        // line 21
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 21, $this->source); })()), "name", [], "any", false, false, false, 21), "html", null, true);
        yield "</li>
                    <li><span class=\"font-semibold text-gray-900 dark:text-white\">Email:</span> ";
        // line 22
        ...
        yield "</li>
                    <li><span class=\"font-semibold text-gray-900 dark:text-white\">Fecha de registro:</span> ";
        // line 23
...
";
    ...
    {
        return array (  177 => 33,  169 => 28,  166 => 27,  164 => 26,  158 => 23,  154 => 22,  150 => 21,  146 => 20,  140 => 17,  133 => 13,  128 => 10,  115 => 9,  101 => 6,  88 => 5,  65 => 3,  42 => 1,);
    }
    ...
    <section class=\"w-full flex flex-col items-center gap-8 py-10 px-4\">
        <section class=\"w-full max-w-4xl bg-white dark:bg-gray-800 rounded-3xl shadow-lg p-8 md:p-12 flex flex-col md:flex-row items-center md:items-start gap-10\">
            ...
            <section class=\"flex-1 w-full\">
                ...
                <ul class=\"space-y-3 text-lg text-gray-700 dark:text-gray-300\">
                    <li><span class=\"font-semibold text-gray-900 dark:text-white\">Nombre de usuario:</span> {{ user.username }}</li>
                    <li><span class=\"font-semibold text-gray-900 dark:text-white\">Nombre:</span> {{ user.name }}</li>
                    <li><span class=\"font-semibold text-gray-900 dark:text-white\">Email:</span> {{ user.email }}</li>
...
{% endblock %}
", "user/profile.html.twig", "C:\\Users\\eduar\\Documents\\GitHub\\proyecto-integrado\\templates\\user\\profile.html.twig");
    }
}
