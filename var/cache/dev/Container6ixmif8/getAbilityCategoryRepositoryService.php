 ...
 */
class getAbilityCategoryRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AbilityCategoryRepository' shared autowired service.
     *
     * @return \App\Repository\AbilityCategoryRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AbilityCategoryRepository.php';

        return $container->privates['App\\Repository\\AbilityCategoryRepository'] = new \App\Repository\AbilityCategoryRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
