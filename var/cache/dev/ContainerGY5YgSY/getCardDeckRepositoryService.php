 ...
 */
class getCardDeckRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CardDeckRepository' shared autowired service.
     *
     * @return \App\Repository\CardDeckRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CardDeckRepository.php';

        return $container->privates['App\\Repository\\CardDeckRepository'] = new \App\Repository\CardDeckRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
